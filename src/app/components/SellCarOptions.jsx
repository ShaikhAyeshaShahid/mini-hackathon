...
const SellCarOptions = () => {
    return (
        <div className="flex flex-col items-center py-8 px-1 bg-gray-100 border border-gray-300 justify-center">
            ...
            <div className="w-full max-w-screen-xl border border-gray-300 rounded-md  shadow-md mt-4 p-4 md:p-8">
                <div className="flex flex-col md:flex-row md:space-x-8">
                    ...
                    <div className="flex flex-col items-center bg-white p-6 rounded-md shadow-md w-full md:w-1/2 text-center">
                        <h3 className="text-xl font-semibold mb-2 text-start" style={{ color: "#233d7b" }}>
